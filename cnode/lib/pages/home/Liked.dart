...
List<Article> allArticleLists = <Article>[];
List<Article> askArticleLists = <Article>[];
List<Article> shareArticleLists = <Article>[];
List<Article> jobArticleLists = <Article>[];
List<Article> goodArticleLists = <Article>[];